...
_PROGRAM_NAME=os.getenv('PROGRAM_NAME', 'default')
...
def parse_args(argv)->tuple[argparse.Namespace, list[str]]:
    ...
    _exec_cmd_parser_error_msg=f"The child python program to run is required after `--exec` Usage:\n {_PROGRAM_NAME}... -- --exec python your_script.py"
